(function (window) {
    ...
    platform.init = function (game) {
        ...
        platform.create(0.05,550, 1, 0.1);
        platform.create(550, 475, 1, 0.1);
        platform.create(0.05, 400, 1, 0.1);
        platform.create(550, 325, 1, 0.1);
        platform.create(0.05, 250, 1, 0.1);
        platform.create(550, 175, 1, 0.1);
       
        // platform.create(80, 200);
